        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <i class="ni ni-collection text-red"></i> Buku Besar
                ...
                <div class="accordion" id="accordionExample">
                    <div>
                        <a href="#" class="nav-link" id="headingOne" data-toggle="collapse" data-target="#collapseOne"
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?= base_url('laporan_aset_neto') ?>">
                                        <i class="fas fa-file-alt text-yellow"></i>Laporan Asset Neto
                                    </a>
                                </li>
                            </div>
                        </div>
