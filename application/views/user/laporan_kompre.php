              ...
              <div class="card-header">
                <div class="row align-items-center py-0">
                  <div class="col-lg-6 col-7">
                    <h6 class="h2 d-inline-block mb-0">Laporan Komprehensif</h6>
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4 text-primary">
                      <ol class="breadcrumb breadcrumb-links">
                        ...
                        <li class="breadcrumb-item active text-black" aria-current="page">Laporan Komprehensif</li>
                      </ol>
                    </nav>
                  </div>
                        ...
                        <table class="table align-items-center table-flush" id="datatable-basic">
							...
							foreach($listJurnal as $row):
                                ...
                                <tr>
                                    ...
                                    <td scope="col">
                                        <?= form_open('laporan_kompre/detail','',['bulan'=>$bulan,'tahun'=>$tahun]) ?>
                                        <?= form_button(['type'=>'submit','content'=>'Lihat Laporan Komprehensif','class'=>'btn btn-success mr-3']) ?>
                                        <?= form_close() ?>
                                    </td>
                                </tr>
                                <?php
