...
<div class="main-content">
	...
	<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
		<div class="container-fluid">
			<!-- Brand -->
			<a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.html">Laporan Posisi Keuangan</a>
			<!-- Form -->
				...
				<div class="card shadow">
					<div class="card-header border-0">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="mb-0">Laporan Asset Neto</h3>
							</div>
						</div>
						<div class="row">
							<div class="col my-3">
								<form action="<?= base_url('laporan_pk/detail') ?>" method="post" class="d-flex flex-row justify-content-center">
						...
						<table class="table align-items-center table-flush">
							...
							foreach($listJurnal as $row):
								...
								<tr>
									...
									<td scope="col">
										<?= form_open('laporan_aset_neto/detail','',['bulan'=>$bulan,'tahun'=>$tahun]) ?>
										<?= form_button(['type'=>'submit','content'=>'Lihat Laporan Aset Neto','class'=>'btn btn-success mr-3']) ?>
										<?= form_close() ?>
									</td>
								</tr>
							<?php
