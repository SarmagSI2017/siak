  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.html">Laporan Laba-Rugi</a>
        <!-- Form -->
    ...
    <!-- Header -->
    <div class="header bg-gradient-primary pb-6 pt-0 pt-md-6">
      <div class="container-fluid">
        ...
        <div class="col mb-5 mb-xl-0">
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <div class="row">
                <div class="col my-3">
                  <form action="<?= base_url('laporan_lr/detail') ?>" method="post" class="d-flex flex-row justify-content-center">
