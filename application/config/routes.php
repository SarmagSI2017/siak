...
// Laporan Laba Rugi
$route['laporan_kompre'] = 'user/laporan_kompre';
$route['laporan_kompre/detail'] = 'user/laporan_kompre_detail';
...
$route['laporan_analisis_rasio'] = 'user/laporan_analisis_rasio';
